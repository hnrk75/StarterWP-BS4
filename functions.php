...
function swp_setup() {
	 ...
	 * If you're building a theme based on StarterWP, use a find and replace
	 * to change 'swp' to the name of your theme in all the template files.
	 */
 ...
 * Classes
 */
require get_template_directory() . '/lib/classes/dashboard-widget.php';
