 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme StarterWP
...
add_action( 'tgmpa_register', 'swp_register_required_plugins' );
 ...
 */
	...
	function swp_register_required_plugins() {
		...
		$config = array(
			'id'           => 'swp',                 // Unique ID for hashing notices for multiple instances of TGMPA.
