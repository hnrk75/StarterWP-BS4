<?php
	...
	function swp_scripts() {
		wp_enqueue_style( 'swp-style', get_stylesheet_directory_uri() . '/style.min.css', array(), '4.6.0' );

		wp_enqueue_script( 'swp-js', get_template_directory_uri() . '/js/dist/scripts.min.js', array('jquery'), ' ', true );
		wp_enqueue_script( 'fontawesome-fa', '//use.fontawesome.com/releases/v5.15.2/js/all.js', array(), '5.15.2' );
